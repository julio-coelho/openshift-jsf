...
public class QuizBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1917354131705048456L;
	...
	private ArrayList<Problem> problems = new ArrayList<Problem>(
			Arrays.asList(
					...
					new Problem(
							"What trademarked slogan describe Java Development ? Write once, ...",
							"run anywhere"),
					...
					new Problem(
							...
							"12"),
					new Problem(
							"What java keyword is used to define a subclass ?",
							"extends"),
					new Problem(
