...
public class RegisterForm implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7093389552714072909L;
	...
	public String getBestDaysConcatened() {

		return Arrays.toString(bestDayToContact);
	}

	public String getColorsConcatened() {
	...
	static {
		educationItems = new LinkedHashMap<String, RegisterForm.Education>();
